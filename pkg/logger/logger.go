...
func getEncoder() zapcore.Encoder {
	...
	encoderConfig := zapcore.EncoderConfig{
		...
		LevelKey:       "level",
		NameKey:        "logger",
		CallerKey:      "caller", //代码调用，如paginator/paginator.go:148
		FunctionKey:    zapcore.OmitKey,
		MessageKey:     "message",
		StacktraceKey:  "stackTrace",
		LineEnding:     zapcore.DefaultLineEnding,      //每行日志的结尾添加“\n”
		EncodeLevel:    zapcore.CapitalLevelEncoder,    //日志级别名称大写，如ERROR、INFO
		EncodeTime:     customTimeEncoder,              //时间格式，我们自定义为2006-01-02 15:04:05
		EncodeDuration: zapcore.SecondsDurationEncoder, //执行时间，以秒为单位
		EncodeCaller:   zapcore.ShortCallerEncoder,     //Caller短格式，如：types/converter.go:17,长格式为绝对路径
	}
	//本地环境配置
	if app.IsLocal() {
		//终端输出的关键词高亮
...
// getLogWriter
//
//	@Description:日志记录介质。Gohub中使用了两种介质，os.Stdout和文件
//	@param filename
//	@param maxSize
//	@param maxBackup
//	@param maxAge
